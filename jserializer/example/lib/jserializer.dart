...
class CitySerializer extends js.ModelSerializer<City> {
  ...
  static const _$IntAdapter2 = IntAdapter2();

  static const _$IntAdapter = IntAdapter();

  static const jsonKeys = {'id', 'name'};

  @override
  City fromJson(json) {
    final int id$Value = safe<int>(
        call: () => _$IntAdapter.fromJson(_$IntAdapter2.fromJson(json['id'])),
        jsonName: 'id');
    final String name$Value = mapLookup(jsonName: 'name', json: json);
